--
-- Data for Name: ingredients; Type: TABLE DATA; Schema: chow; Owner: admin
--
...
--
-- Data for Name: recipes; Type: TABLE DATA; Schema: chow; Owner: admin
--

INSERT INTO chow.recipes (id, title, description, rating, url, image) VALUES ('972e7bbe-9bb6-40ed-8bfb-dc130153537d', 'Crispy chicken fajitas', 'This recipe is a stripped down chicken fajita with only a few ingredients. But put together and you have a wonderfully delicious meal that will satisfy your cravings. The crispy chicken strips are the star of the show with juicy tomatoes and crunchy lettuce providing supporting roles with lashings of sour cream and our tasty ‘Thick ‘n’ Chunky Salsa’ topping off this tasty cast. Get together with your family and friends and enjoy this simple but delicious crispy chicken fajita!', 4, 'https://www.oldelpaso.co.uk/mexican-recipes/crispy-chicken-fajitas', 'https://www.oldelpaso.co.uk/-/media/oep/uk/recipes/crispy-chicken-fajitas-hero.jpg');
INSERT INTO chow.recipes (id, title, description, rating, url, image) VALUES ('c2cc5863-1150-42a3-b4b3-06da2ac436fe', 'Slow cooker chicken curry', 'Try this easy, one-pot chicken curry thats low-fat, low-calorie and delivers three of your five-a-day. Its slow-cooked so the meat is beautifully tender', 5, 'https://www.bbcgoodfood.com/recipes/slow-cooker-chicken-curry', 'https://www.bbcgoodfood.com/sites/default/files/styles/recipe/public/recipe/recipe-image/2017/09/slow-cooker-chicken-curry.jpg');


--
-- Data for Name: units; Type: TABLE DATA; Schema: chow; Owner: admin
--
...
--
-- Data for Name: recipe_ingredients; Type: TABLE DATA; Schema: chow; Owner: admin
--
